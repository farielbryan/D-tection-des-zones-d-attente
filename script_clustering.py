...
EPS = 0.005         # rayon en degrés pour DBSCAN 
MIN_SAMPLES = 20   # nb min de points pour former un cluster
...
def process_one_csv(path, basename):
    ...
    png_out = os.path.join(OUTPUT_DIR, f"{basename}_clustering.png")
    html_out = os.path.join(OUTPUT_DIR, f"{basename}_map.html")
